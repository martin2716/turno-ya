...
class TurnoAdmin(admin.ModelAdmin):
    list_display = ("fecha", "medico", "paciente_apellido", "paciente_nombre", "disponibilidad")
    list_filter = ("disponibilidad", "medico")
    search_fields = ("paciente_apellido", "paciente_nombre", "medico__apellido", "medico__nombre")
